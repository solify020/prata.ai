...
export function AnimatedBeamDemo() {
  ...
  return (
    <div
      className="relative flex h-[450px] w-full items-center justify-center overflow-hidden rounded-lg border bg-background p-4"
      ref={containerRef}
    >
      <div className="flex size-full max-w-[280px] max-h-[280px] items-stretch justify-between gap-6">
